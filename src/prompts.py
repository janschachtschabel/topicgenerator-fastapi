...
BASE_INSTRUCTIONS = (
    ...
    "FORMATIERUNGSREGELN:\n"
    "1) **TITEL**\n"
    "   - Langformen, Substantive, keine Artikel, Adjektive klein\n"
    ...
    "     - *Formatierung:* Zusammengesetzte oder Gegenüberstellungs-Titel zulässig, sparsam („Globalisierung vs. Regionalität“)\n\n"
